...
CREATE TABLE `answers` (
  ...
  `category_leaf_id` int(11) DEFAULT '-1',
  PRIMARY KEY (`id`),
...
INSERT INTO `answers` VALUES (12,'9-210CF7AA5E1682C9C9D4511F88FA2789','{\"질문1\": \"item1\", \"질문2\": {\"2019년\": {\"근로조건\": \"불만족\", \"인권문제\": \"불만족\", \"개인 의견 기술\": \"wef\"}, \"2020년\": {\"근로조건\": \"만족함\", \"인권문제\": \"만족함\", \"개인 의견 기술\": \"wef\"}, \"2021년\": {\"근로조건\": \"만족함\", \"인권문제\": \"불만족\", \"개인 의견 기술\": \"wfe\"}}}','210CF7AA5E1682C9C9D4511F88FA2789',9,'2019-09-15 23:20:32',99,-1),(15,'9-210CF7AA5E1682C9C9D4511F88FA2789','{\"질문1\": \"item1\", \"질문2\": {\"2019년\": {\"근로조건\": \"불만족\", \"인권문제\": \"불만족\", \"개인 의견 기술\": \"wef1\"}, \"2020년\": {\"근로조건\": \"만족함\", \"인권문제\": \"만족함\", \"개인 의견 기술\": \"wef2\"}, \"2021년\": {\"근로조건\": \"만족함\", \"인권문제\": \"불만족\", \"개인 의견 기술\": \"wfe3\"}}}','210CF7AA5E1682C9C9D4511F88FA2789',9,'2019-09-16 01:14:32',99,-1),(16,'9-210CF7AA5E1682C9C9D4111F88FA1789','{\"질문1\": \"item2\", \"질문2\": {\"2019년\": {\"근로조건\": \"만족함\", \"인권문제\": \"만족함\", \"개인 의견 기술\": \"힘듬\"}, \"2020년\": {\"근로조건\": \"불만족\", \"인권문제\": \"불만족\", \"개인 의견 기술\": \"힘듬\"}, \"2021년\": {\"근로조건\": \"만족함\", \"인권문제\": \"만족함\", \"개인 의견 기술\": \"힘듬\"}}}','210CF7AA5E1682C9C9D4111F88FA1789',9,'2019-09-16 15:45:09',99,-1),(17,'9-210CF7AA5E1682C9C9D4111F88FA1789','{\"질문1\": \"item2\", \"질문2\": {\"2019년\": {\"근로조건\": \"만족함\", \"인권문제\": \"만족함\", \"개인 의견 기술\": \"힘듬2\"}, \"2020년\": {\"근로조건\": \"불만족\", \"인권문제\": \"불만족\", \"개인 의견 기술\": \"힘듬2\"}, \"2021년\": {\"근로조건\": \"만족함\", \"인권문제\": \"만족함\", \"개인 의견 기술\": \"힘듬2\"}}}','210CF7AA5E1682C9C9D4111F88FA1789',9,'2019-09-16 16:32:44',99,-1);
...
CREATE TABLE `cquestions` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=104 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='type ''select'' radio, type ''file'', type ''text'', type ''table'', type ''check''';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `questions` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='type ''select'' radio, type ''file'', type ''text'', type ''table'', type ''check''';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_info` VALUES ('210CF7AA5E1682C9C9D4111F88FA1789','dev4@dev4.com','dev4',NULL,'/image/210CF7AA5E2682C9C9D4511F88FE2789/admin.jpg','이응용','dev4','Power','0104443333','132, My Street,','Seoul','Kor','123123','this is admin account do not use this account','',0,'sam1','2019-09-15 00:13:24',1,NULL,NULL),('210CF7AA5E1682C9C9D4511F88FA2789','dev@dev.com','dev',NULL,'/image/210CF7AA5E2682C9C9D4511F88FE2789/admin.jpg','김철수','dev','Power','0104443333','132, My Street,','Seoul','Kor','123123','this is admin account do not use this account','',0,'sam1','2019-09-15 00:13:08',1,NULL,NULL),('210CF7AA5E2182C9C9D4511F88FE2789','admin@admin.com','admin',NULL,'/image/210CF7AA5E2682C9C9D4511F88FE2789/admin.jpg','관리자','Super','Admin','0104443333','132, My Street,','Seoul','Kor','123123','this is admin account do not use this account','admincode',1,'sam1','2019-09-15 00:13:08',1,NULL,NULL),('210CF7AA5E2482C9C9D4311F88FA1789','dev3@dev3.com','dev4',NULL,'/image/210CF7AA5E2682C9C9D4511F88FE2789/admin.jpg','김다래','dev3','Power','0104443333','132, My Street,','Seoul','Kor','123123','this is admin account do not use this account','',0,'sam1','2019-09-15 00:13:24',0,NULL,NULL),('210CF7AA5E2682C9C9D4511F88FA1789','dev2@dev2.com','dev2',NULL,'/image/210CF7AA5E2682C9C9D4511F88FE2789/admin.jpg','박민수','dev2','Power','0104443333','132, My Street,','Seoul','Kor','123123','this is admin account do not use this account','',0,'sam1','2019-09-15 00:13:24',1,NULL,NULL),('210CF7AA5E4682C9C9D4511F88FE2778','user@user.com','user',NULL,'/image/210CF7AA5E2682C9C9D4511F88FE2789/admin.jpg','김승철','Normal','Mad','0104443333','132, My Street,','Jeju','Kor','333444','this is user account ','',0,'sam1','2019-09-15 00:13:24',0,NULL,NULL),('a5b15e70-dfff-11e9-a352-ad34ad4ac9bb','james2@james2.com','james2',NULL,NULL,'james2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',0,'sam1','2019-09-26 10:48:13',1,'sam1','AMore'),('c1747c80-dfa7-11e9-b27a-4f89010d778c','james@james.com','james',NULL,NULL,'james',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',0,'amo1','2019-09-26 10:37:25',1,'jamescor','wefwefwfe');
...
-- Dump completed on 2019-09-26 11:03:46
